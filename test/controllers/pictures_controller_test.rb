...
class PicturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture" do
    assert_difference('Picture.count') do
      post pictures_url, params: { picture: { picture: @picture.picture, post_id: @picture.post_id } }
    end
  ...
  test "should update picture" do
    patch picture_url(@picture), params: { picture: { picture: @picture.picture, post_id: @picture.post_id } }
